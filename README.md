...
segment (as in RFC 3986) of the WebSocket path as the upstream endpoint. The
upstream endpoint is encoded like an authority without userinfo (as in RFC 3986,
